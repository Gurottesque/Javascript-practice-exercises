...
function grupoNumeros(contador, mayor, menor, mayor_150, negativos, promedio, contar_positivos){
    ...
    if(number==0){
        ...
        return grupoNumeros(contador, mayor, menor, mayor_150, negativos, promedio, contar_positivos);
    }else{
        ...
        return grupoNumeros(contador+1, mayor, menor, mayor_150, negativos, promedio, contar_positivos);
    }
}else{
